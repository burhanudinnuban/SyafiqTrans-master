...
public class UpdateOrder extends AppCompatActivity {
    ...
    public void onCreate(Bundle SaveInstanceState) {
        ...
        selectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(UpdateOrder.this,
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(date.getText().toString().length()==0) {
                    ...
                    Toast.makeText(UpdateOrder.this, "Tipe Bus Diperlukan Mohon diisi!!", Toast.LENGTH_LONG).show();
                }else if(tujuan.getSelectedItem().toString().length()==0){
                    Toast.makeText(UpdateOrder.this, "Tujuan Pariwisata Mohon diisi!!", Toast.LENGTH_LONG).show();
                } else
                { Toast.makeText(UpdateOrder.this, "Order Berhasil Dimasukkan Silahkan Lakukan Transaksi!!", Toast.LENGTH_LONG).show();
    ...
    private void getTokenRest (final String date,final String bus, final String tujuan, final String sHarga){
        String url = "http://193.168.195.201/burhan/index.php/Rest/RestUser/update_data_order";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                JSONObject jObject = null;
